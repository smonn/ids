...
Once the code is green, run `/review` and do one round of refactoring off its findings — this is where the refactoring the `/tdd` loop deferred happens, alongside fixing any spec or standards issues it surfaces.
